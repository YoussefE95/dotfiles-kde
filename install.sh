...
yay -Syu && yay -S kitty starship ttf-jetbrains-mono neovim ripgrep zathura zathura-pdf-poppler wl-clipboard ranger nvtop htop expressvpn dropbox discord spotify-launcher spicetify-cli obsidian jq nodejs npm python-pipx python-pillow zsh zsh-autosuggestions zsh-history-substring-search zsh-syntax-highlighting
