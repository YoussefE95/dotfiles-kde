...
yay -Syu && yay -S kitty starship ttf-jetbrains-mono ttf-jetbrains-mono-nerd code neovim ripgrep wl-clipboard ranger nvtop htop expressvpn dropbox discord spotify-launcher spicetify-cli obsidian jq python-pipx python-pillow docker docker-buildx zsh zsh-autosuggestions zsh-history-substring-search zsh-syntax-highlighting
